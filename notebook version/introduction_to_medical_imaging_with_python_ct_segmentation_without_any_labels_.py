...
if __name__ == "__main__":
    ...
    for c, exam_path in enumerate(paths):
        ...
        out_mask_name = outpath + img_name + "_mask.png"
        contour_name = contour_path + img_name + "_contour.png"
    ...
    for c, exam_path in enumerate(paths):
        img_name = os.path.split(exam_path)[-1].split('.nii')[0]
        vessel_name = vessels + img_name + "_vessel_only_mask.png"
